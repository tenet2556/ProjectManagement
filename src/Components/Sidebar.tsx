...
const navItems: { href: string; label: string; icon: React.ReactNode }[] = [
  ...
  { href: '/projects', label: 'Project Management', icon: <FolderIcon /> },
  { href: '/tasks', label: 'Task Management', icon: <TaskIcon /> },
  { href: '/teams', label: 'Team Management', icon: <TeamIcon /> },
  { href: '/resources', label: 'Resource Allocation', icon: <ResourceIcon /> },
  { href: '/budget', label: 'Budget', icon: <BudgetIcon /> },
  { href: '/reports', label: 'Reports & Analytics', icon: <ChartIcon /> },
  { href: '/kanban', label: 'Kanban Board', icon: <KanbanIcon /> },
  ...
  return (
    <aside className="fixed left-0 top-0 z-20 flex h-screen w-64 flex-col bg-slate-900 text-slate-200 shadow-xl">
      <div className="flex h-16 items-center border-b border-slate-700/50 px-5">
        <span className="text-lg font-bold tracking-tight text-white">Project Manager</span>
      </div>
      <nav className="flex-1 overflow-y-auto px-3 py-4">
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
                    isActive ? 'bg-slate-700/80 text-white' : 'text-slate-300 hover:bg-slate-700/50 hover:text-white'
                  }`}
                >
                  {item.icon}
                  {item.label}
        ...
        <div className="mt-4 border-t border-slate-700/50 pt-4">
          <Link
            href="/logout"
            className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-300 transition-colors hover:bg-red-900/30 hover:text-red-300"
          >
            <LogoutIcon />
            Logout
          </Link>
