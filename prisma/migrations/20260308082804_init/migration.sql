-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('ACTIVE', 'COMPLETED', 'DELAYED');
...
-- AddForeignKey
ALTER TABLE "Team" ADD CONSTRAINT "Team_projectManagerId_fkey" FOREIGN KEY ("projectManagerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
